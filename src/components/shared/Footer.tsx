      ...
      <div className="relative z-10 container mx-auto px-6 pt-32 pb-12 md:px-12 lg:px-20">
        ...
        <div className="grid gap-10 border-b border-white/[0.08] pb-12 lg:grid-cols-[1.2fr_1fr] lg:items-start">
          ...
          <div>
            <Link
              href="/"
              className="inline-flex items-center gap-3 text-lg font-black text-white"
            >
              <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-primary shadow-[0_0_22px_rgba(229,9,20,0.45)]">
