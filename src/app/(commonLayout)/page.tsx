...
export default function Home() {
  ...
  const { hasActiveSubscription, activePlan, subscriptionEndDate } =
    useUserAccess();
  ...
  const [pricingBusy, setPricingBusy] = useState<false | "MONTHLY" | "YEARLY">(
    false,
  );
  ...
  const isPageLoading =
    trendingLoading || featuredCuratedLoading || topRatedLoading;
    ...
    <div className="bg-[#0b0b0b] min-h-screen">
      ...
      <div className="relative z-20 -mt-24 space-y-4">
              ...
              <div className="grid w-full gap-3 sm:grid-cols-2 lg:grid-cols-5">
                ...
                <div className="space-y-2">
                  <Select
                    ...
                    onValueChange={(v) =>
                      setHomeGenre(v === ALL_GENRES_VALUE ? "" : v)
                    }
                  >
        ...
        <section className="container mx-auto px-6 md:px-12 lg:px-20 py-24 text-center">
          <h3 className="text-zinc-600 font-black uppercase text-[10px] tracking-[1em] mb-4">
            Discover More
          </h3>
